...
// BeginRun
//------------------
void DReaction_factory_p2pi_trees::BeginRun(const std::shared_ptr<const JEvent> &locEvent)
{
...
// Process
//------------------
void DReaction_factory_p2pi_trees::Process(const std::shared_ptr<const JEvent> &locEvent)
  {
	// DOCUMENTATION:
...
// Finish
//------------------
void DReaction_factory_p2pi_trees::Finish()
{
