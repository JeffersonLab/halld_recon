...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->Add(new DEventProcessor_npp_hists()); //register this plugin
		locApplication->Add(new DFactoryGenerator_npp_hists()); //register the factory generator
	}
} // "C"
...
// Init
//------------------
void DEventProcessor_npp_hists::Init()
{
...
// BeginRun
//------------------
void DEventProcessor_npp_hists::BeginRun(const std::shared_ptr<const JEvent> &event)
{
...
// Process
//------------------
void DEventProcessor_npp_hists::Process(const std::shared_ptr<const JEvent> &event)
{
...
int DEventProcessor_npp_hists::Get_FileNumber(const std::shared_ptr<const JEvent> &event) const
{
	...
	JEventSource* locEventSource = event->GetJEventSource();
...
// EndRun
//------------------
void DEventProcessor_npp_hists::EndRun()
{
...
// Finish
//------------------
void DEventProcessor_npp_hists::Finish()
{
