// $Id$
//
//    File: DReaction_factory_npp_hists.cc
...
jerror_t DReaction_factory_npp_hists::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	/************************************************** npp_hists Reaction Definition *************************************************/

	locReaction = new DReaction("npp_hists");
	...
	locReactionStep = new DReactionStep(Gamma, Pb208, {Pi0, Pi0}, Pb208);
	...
	// locReaction->Enable_TTreeOutput("tree_npp_hists.root", false); //true/false: do/don't save unused hypotheses

	/**************************************************** npp_hists Analysis Actions ****************************************************/
	...
	locReaction->Add_AnalysisAction(new DHistogramAction_InvariantMass(locReaction, Pi0, false, 222, 0.08, 0.19, "Pi0_PreKinFit"));
	locReaction->Add_AnalysisAction(new DCutAction_InvariantMass(locReaction, Pi0, false, 0.12, 0.15));
	locReaction->Add_AnalysisAction(new DHistogramAction_InvariantMass(locReaction, 0, {Pi0, Pi0}, false, 1000, 0.0, 2.0, "2Pi0_PreKinFit"));
	...
	// HISTOGRAM MASSES //false/true: measured/kinfit data
	locReaction->Add_AnalysisAction(new DHistogramAction_InvariantMass(locReaction, 0, {Pi0, Pi0}, false, 1000, 0.0, 2.0, "2Pi0_PostKinFit"));
	locReaction->Add_AnalysisAction(new DHistogramAction_InvariantMass(locReaction, 0, {Pi0, Pi0}, true, 1000, 0.0, 2.0, "2Pi0_KinFit"));
