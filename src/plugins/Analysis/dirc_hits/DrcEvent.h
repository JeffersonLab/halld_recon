...
public:
  ...
  Double_t GetPhiMass() const { return fphi; }
  Double_t GetRhoMass() const { return frho; }
  Double_t GetMissingMass() const { return fmiss; }
  Double_t GetChiSq_pi() const { return fchisq_pi; }
  Double_t GetChiSq_k() const { return fchisq_k; }  
  // Mutators
  ...
  void SetPhiMass(Double_t val) { fphi = val; }
  void SetRhoMass(Double_t val) { frho =val; }
  void SetMissingMass(Double_t val) { fmiss =val; }
  void SetChiSq_pi(Double_t val) { fchisq_pi =val; }
  void SetChiSq_k(Double_t val) { fchisq_k =val; }
