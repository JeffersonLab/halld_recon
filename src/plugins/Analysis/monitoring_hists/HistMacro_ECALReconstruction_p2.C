// hnamepath: /Independent/Hist_DetectorPID/ECAL/DeltaTVsP_Proton
// hnamepath: /Independent/Hist_DetectorPID/ECAL/DeltaTVsP_Pi+
// hnamepath: /Independent/Hist_DetectorPID/ECAL/DeltaTVsP_Pi-

{
	...
	if(TVirtualPad::Pad() == NULL)
		locCanvas = new TCanvas("ECALReconstruction_p2", "ECALReconstruction_p2", 1200, 800);
	else
