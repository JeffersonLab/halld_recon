#define MakeAmpToolsFlat_pi0_cxx
#include "MakeAmpToolsFlat_pi0.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void MakeAmpToolsFlat_pi0::Loop(Int_t foption)
{
//   In a ROOT session, you can do:
//      root> .L MakeAmpToolsFlat_pi0.C
//      root> MakeAmpToolsFlat_pi0 t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  // Process entries in Tree
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      TLorentzVector Sum_p4_kin = Target + *beam_p4_kin - *decaypi01_p4_kin - *decaypi02_p4_kin - *misspb_p4_kin;
      cout<< "jentry=" << jentry << " px=" << Sum_p4_kin.Px()<< " py=" << Sum_p4_kin.Py()<< " pz=" << Sum_p4_kin.Pz()<< " E=" << Sum_p4_kin.E()<< endl << endl;*/


   m_e[0] = decaypi01_p4_kin->E();
   m_px[0] = decaypi01_p4_kin->Px();
   m_py[0] = decaypi01_p4_kin->Py();
   m_pz[0] = decaypi01_p4_kin->Pz();
   m_e[1] = decaypi02_p4_kin->E();
   ...
   twopi = *decaypi01_p4_kin + *decaypi02_p4_kin;
