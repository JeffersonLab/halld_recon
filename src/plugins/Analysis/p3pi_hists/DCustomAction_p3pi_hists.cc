...
void DCustomAction_p3pi_hists::Initialize(const std::shared_ptr<const JEvent>& locEvent)
{
...
bool DCustomAction_p3pi_hists::Perform_Action(const std::shared_ptr<const JEvent>& locEvent, const DParticleCombo* locParticleCombo)
{
