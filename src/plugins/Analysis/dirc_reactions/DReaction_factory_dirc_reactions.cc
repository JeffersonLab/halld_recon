...
// BeginRun
//------------------
void DReaction_factory_dirc_reactions::BeginRun(const std::shared_ptr<const JEvent> &locEvent)
{
}
...
// Process
//------------------
void DReaction_factory_dirc_reactions::Process(const std::shared_ptr<const JEvent> &locEvent)
{
...
// Finish
//------------------
void DReaction_factory_dirc_reactions::Finish()
{
