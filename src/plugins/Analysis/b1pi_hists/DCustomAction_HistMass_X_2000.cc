...
void DCustomAction_HistMass_X_2000::Initialize(const std::shared_ptr<const JEvent>& locEvent)
{
...
bool DCustomAction_HistMass_X_2000::Perform_Action(const std::shared_ptr<const JEvent>& locEvent, const DParticleCombo* locParticleCombo)
{
