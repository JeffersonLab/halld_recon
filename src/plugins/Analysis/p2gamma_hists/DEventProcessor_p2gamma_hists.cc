...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->Add(new DEventProcessor_p2gamma_hists()); //register this plugin
		locApplication->Add(new DFactoryGenerator_p2gamma_hists()); //register the factory generator
	}
} // "C"
...
// Init
//------------------
void DEventProcessor_p2gamma_hists::Init()
{
...
// BeginRun
//------------------
void DEventProcessor_p2gamma_hists::BeginRun(const std::shared_ptr<const JEvent>& locEvent)
{
...
// Process
//------------------
void DEventProcessor_p2gamma_hists::Process(const std::shared_ptr<const JEvent>& locEvent)
{
	...
	//REQUIRED: To run an analysis, You MUST call one at least of the below code fragments. 
	 ...
	 //Recommended: Write surviving particle combinations (if any) to output ROOT TTree
        ...
        locEventWriterROOT->Fill_DataTrees(locEvent, "p2gamma_hists");
...
// EndRun
//------------------
void DEventProcessor_p2gamma_hists::EndRun()
{
...
// Finish
//------------------
void DEventProcessor_p2gamma_hists::Finish()
{
