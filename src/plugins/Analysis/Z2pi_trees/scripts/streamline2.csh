...
# hadd tree_pippimmisspb208.root ../root/trees/tree_pippimmisspb208__B2_gen_2pi_primakoff_${base}_${run}_*.root
...
# mv DSelector_Z2pi_trees2.root DSelector_Z2pi_trees_${base}_signal_${maxev}.root
# mv treeFlat_DSelector_Z2pi_trees.root treeFlat_DSelector_Z2pi_trees_${base}_signal_${maxev}.root
# echo root -l -q  plot_Z2pi_trees.C\(\"DSelector_Z2pi_trees_${base}_signal_${maxev}\"\)
...
# echo hd_root -PPLUGINS=monitoring_hists,mcthrown_tree -PNTHREADS=4 -PEVENTS_TO_KEEP=${maxev} ../../gen_2pi_primakoff_flat/hddm/dana_rest_gen_2pi_primakoff_${base}_${run}_*.hddm -o hd_root_Z2pi_trees_${base}_flat_${maxev}_gen.root
...
# rm -f tree_pippimmisspb208.root
# hadd tree_pippimmisspb208.root ../../gen_2pi_primakoff_flat/root/trees/tree_pippimmisspb208__B2_gen_2pi_primakoff_${base}_${run}_*.root
...
# mv DSelector_Z2pi_trees2.root DSelector_Z2pi_trees_${base}_flat_${maxev}.root
# mv treeFlat_DSelector_Z2pi_trees.root treeFlat_DSelector_Z2pi_trees_${base}_flat_${maxev}.root
# root -b -q  plot_Z2pi_trees.C\(\"DSelector_Z2pi_trees_${base}_flat_${maxev}\"\)
#No longer needed: tree_to_amptools tree_DSelector_Z2pi_trees_${base}_flat_${maxev}.root pippimmisspb208_Tree
# root -b -q treeFlat_DSelector_Z2pi_trees_${base}_flat_${maxev}.root 'call_MakeAmpToolsFlat.C(2)'   # avoid any negative weights
# mv AmpToolsInputTreeInTime.root treeFlat_DSelector_Z2pi_trees_${base}_flat_${maxev}_amptools.root   
