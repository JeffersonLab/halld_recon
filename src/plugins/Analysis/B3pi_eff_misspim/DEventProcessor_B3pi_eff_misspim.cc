...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->Add(new DEventProcessor_B3pi_eff_misspim()); //register this plugin
		locApplication->Add(new DFactoryGenerator_B3pi_eff_misspim()); //register the factory generator
	}
} // "C"
...
// Init
//------------------
void DEventProcessor_B3pi_eff_misspim::Init()
{
...
// BeginRun
//------------------
void DEventProcessor_B3pi_eff_misspim::BeginRun(const std::shared_ptr<const JEvent> &locEvent)
{
...
// Process
//------------------
void DEventProcessor_B3pi_eff_misspim::Process(const std::shared_ptr<const JEvent> &locEvent)
{
	...
	locEventWriterROOT->Fill_DataTrees(locEvent, "B3pi_eff_misspim");
	...
	*/
	...
	for(size_t loc_i = 0; loc_i < locAnalysisResultsVector.size(); ++loc_i)
	{
		...
		if(!locPassedParticleCombos.empty())
			locEventWriterREST->Write_RESTEvent(locEvent, "B3pi_eff_misspim"); //string is part of output file name
	}
	*/
...
int DEventProcessor_B3pi_eff_misspim::Get_FileNumber(const std::shared_ptr<const JEvent>& locEvent) const
{
...
// EndRun
//------------------
void DEventProcessor_B3pi_eff_misspim::EndRun()
{
...
// Finish
//------------------
void DEventProcessor_B3pi_eff_misspim::Finish()
{
