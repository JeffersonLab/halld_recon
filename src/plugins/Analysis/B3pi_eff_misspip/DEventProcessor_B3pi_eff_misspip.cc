...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->Add(new DEventProcessor_B3pi_eff_misspip()); //register this plugin
		locApplication->Add(new DFactoryGenerator_B3pi_eff_misspip()); //register the factory generator
	}
} // "C"
...
// Init
//------------------
void DEventProcessor_B3pi_eff_misspip::Init()
{
...
// BeginRun
//------------------
void DEventProcessor_B3pi_eff_misspip::BeginRun(const std::shared_ptr<const JEvent> &locEvent)
{
...
// Process
//------------------
void DEventProcessor_B3pi_eff_misspip::Process(const std::shared_ptr<const JEvent> &locEvent)
{
	...
	locEventWriterROOT->Fill_DataTrees(locEvent, "B3pi_eff_misspip");
	...
	*/
	...
	for(size_t loc_i = 0; loc_i < locAnalysisResultsVector.size(); ++loc_i)
	{
		...
		if(!locPassedParticleCombos.empty())
			locEventWriterREST->Write_RESTEvent(locEvent, "B3pi_eff_misspip"); //string is part of output file name
	}
	*/
...
int DEventProcessor_B3pi_eff_misspip::Get_FileNumber(const std::shared_ptr<const JEvent>& locEvent) const
{
...
// EndRun
//------------------
void DEventProcessor_B3pi_eff_misspip::EndRun()
{
...
// Finish
//------------------
void DEventProcessor_B3pi_eff_misspip::Finish()
{
