...
void InitPlugin(JApplication *app){
	InitJANAPlugin(app);
	app->AddProcessor(new JEventProcessor_fwmpc_scan());
}
} // "C"


//------------------
// JEventProcessor_fwmpc_scan (Constructor)
//------------------
JEventProcessor_fwmpc_scan::JEventProcessor_fwmpc_scan()
{

}

//------------------
// ~JEventProcessor_fwmpc_scan (Destructor)
//------------------
JEventProcessor_fwmpc_scan::~JEventProcessor_fwmpc_scan()
{
...
// init
//------------------
jerror_t JEventProcessor_fwmpc_scan::init(void)
{
...
// brun
//------------------
jerror_t JEventProcessor_fwmpc_scan::brun(JEventLoop *eventLoop, int32_t runnumber)
{
...
// evnt
//------------------
jerror_t JEventProcessor_fwmpc_scan::evnt(JEventLoop *loop, uint64_t eventnumber)
{
...
// erun
//------------------
jerror_t JEventProcessor_fwmpc_scan::erun(void)
{
...
// fini
//------------------
jerror_t JEventProcessor_fwmpc_scan::fini(void)
{
