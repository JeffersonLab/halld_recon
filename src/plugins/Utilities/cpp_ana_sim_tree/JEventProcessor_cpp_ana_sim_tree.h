// $Id$
//
//    File: JEventProcessor_cpp_ana_sim_tree.h
...
#ifndef _JEventProcessor_cpp_ana_sim_tree_
#define _JEventProcessor_cpp_ana_sim_tree_
...
class JEventProcessor_cpp_ana_sim_tree:public JEventProcessor{
    public:
        JEventProcessor_cpp_ana_sim_tree();
        ~JEventProcessor_cpp_ana_sim_tree();
        const char* className(void){return "JEventProcessor_cpp_ana_sim_tree";}
        ...
        float nCT, nFS, nFh, nMh, nFMT,FEc8, FE38, FE58, Fcw18,Fdcw18,FNc18,Fcw28,Fdcw28,FNc28,Fcw38,Fdcw38,FNc38,Fcw48,Fdcw48,FNc48,Fcw58,
            ...
            fcalblocksn9,sumu8,sumu9,sumv8,sumv9,fmwpc1n,fmwpc2n,fmwpc3n,fmwpc4n,fmwpc5n,fmwpc6n,cn8,cn9,w_2pi,p1x,p1y,p1z,p1e,p2x,p2y,p2z,p2e,epimlp_plus,epimlp_minus,
            bE,bT,t1t,t2t,t1e,t2e,elas,wght,mm_chi,mp_8_kf,mp_9_kf,fcalepkf8,fcalepkf9,mlp_kf_8,mlp_kf_9,w_2mu_kf,p1x_kf,p1y_kf,p1z_kf,p1e_kf,p2x_kf,
        ...
        TBranch *nChargedTracks, *nFCALShowers, *nFCALhits, *nMWPChits, *nFMWPCMatchedTracks, *FCAL_E_center_8, *FCAL_E_3x3_8,
            ...
            *Pion1_pe,*Pion2_px,*Pion2_py,*Pion2_pz,*Pion2_pe,*EPI_MLP_Response_plus,*EPI_MLP_Response_minus,*Beam_Energy,*Beam_Time,*Track1_Time,
            *Track2_Time,*Track1_Energy,*Track2_Energy,*Elasticity,*Weight,*KinFit_Chisq,*Track_Mom_8_KinFit,*Track_Mom_9_KinFit,*FCAL_eoverp_kf_8,*FCAL_eoverp_kf_9,
...
#endif // _JEventProcessor_cpp_ana_sim_tree_
