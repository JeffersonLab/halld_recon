// $Id$
//
//    File: JEventProcessor_cpp_ana_tree.cc
...
#include "JEventProcessor_cpp_ana_tree.h"
...
void InitPlugin(JApplication *app){
    InitJANAPlugin(app);
    app->Add(new JEventProcessor_cpp_ana_tree());
}
} // "C"


//------------------
// JEventProcessor_cpp_ana_tree (Constructor)
//------------------
JEventProcessor_cpp_ana_tree::JEventProcessor_cpp_ana_tree()
{
...
//------------------
// ~JEventProcessor_cpp_ana_tree (Destructor)
//------------------
JEventProcessor_cpp_ana_tree::~JEventProcessor_cpp_ana_tree()
{
}
...
// Init
//------------------
void JEventProcessor_cpp_ana_tree::Init()
{
    ...
    ofile = new TFile("cpp_data_to_classify.root","RECREATE");
...
// BeginRun
//------------------
void JEventProcessor_cpp_ana_tree::BeginRun(const std::shared_ptr<const JEvent> &event)
{
...
// Process
//------------------
void JEventProcessor_cpp_ana_tree::Process(const std::shared_ptr<const JEvent> &event)
{
    ...
    if(!(trig[0]->Get_L1TriggerBits() & 0x2)) return; 
...
// EndRun
//------------------
void JEventProcessor_cpp_ana_tree::EndRun()
{
...
// Finish
//------------------
void JEventProcessor_cpp_ana_tree::Finish()
{
...
double JEventProcessor_cpp_ana_tree::calculateTrackEnergy(DVector3 ptrack_mom, double pmass){
...
double JEventProcessor_cpp_ana_tree::getEPIClassifierMinus(double EoverP_minus, double FCAL_DOCA_minus, double FCAL_E9E25_minus){
...
double JEventProcessor_cpp_ana_tree::getEPIClassifierPlus(double EoverP_plus, double FCAL_DOCA_plus, double FCAL_E9E25_plus){
