// hnamepath: /HLDetectorTiming/TPOL/TPOL time
// hnamepath: /HLDetectorTiming/TPOL/TPOL time per sector

{
	...
	//Get Histograms
	TH1I* TPOLHit_Timing    = (TH1I*)gDirectory->Get("TPOL/TPOL time");
	TH2I* TPOHit_Timing_vs_sector  = (TH2I*)gDirectory->Get("TPOL/TPOL time per sector");
	...
	{
	    TPOLHit_Timing->GetXaxis()->SetRangeUser(-10.0,610.0);
	    TPOLHit_Timing->Draw();
	...
	{
	    TPOLHit_Timing_vs_sector->GetXaxis()->SetRangeUser(0.0,33.0);
	    TPOLHit_Timing_vs_sector->GetYaxis()->SetRangeUser(-10.0,610.0);
