...
// Init
//------------------
void DBCALTDCDigiHit_factory_KO::Init()
{
...
// BeginRun
//------------------
void DBCALTDCDigiHit_factory_KO::BeginRun(const std::shared_ptr<const JEvent>& event)
{
}
...
// Process
//------------------
void DBCALTDCDigiHit_factory_KO::Process(const std::shared_ptr<const JEvent>& event)
{
	vector<const DBCALTDCDigiHit*> bcaltdcdigihits;
	event->Get(bcaltdcdigihits, ""); // get original hits
	...
	for( auto hit : bcaltdcdigihits ){
		...
		if( BCAL_tdc_cell_eff.count(key) ){
			if( distribution(generator) <= BCAL_tdc_cell_eff[key]) Insert( const_cast<DBCALTDCDigiHit*>(hit) );
		}else{
			Insert( const_cast<DBCALTDCDigiHit*>(hit) );
		}
	}
}
...
// EndRun
//------------------
void DBCALTDCDigiHit_factory_KO::EndRun()
{
}
...
// Finish
//------------------
void DBCALTDCDigiHit_factory_KO::Finish()
{
}
