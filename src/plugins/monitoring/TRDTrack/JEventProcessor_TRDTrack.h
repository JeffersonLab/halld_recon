...
private:
  ...
  //-Sim
  TH2D *hTRDProjectionXY, *hProjectionXYDiff, *hProjectionXYHitDiff, *hSegmentXYDiff;
  ...
  TH1D *hfCALShower_el, *hfCALEP_TRD_el, *hfCALMatchX_el, *hfCALMatchY_el, *hfCALShower_pi, *hfCALEP_TRD_pi, *hfCALMatchX_pi, *hfCALMatchY_pi, *hfCALEP_cut_el, *hfCALEP_cut_pi;
  ...
  TH1D *hnumElTracks, *hnumPiTracks;
