...

{
	...
	if( comp_cratio ){
		...
		comp_cratio->GetXaxis()->SetTitleSize(0.045);
		comp_cratio->GetXaxis()->SetTitleOffset(1.0);
		
		comp_cratio_bkgd->SetStats(0);
		comp_cratio_bkgd->Rebin(2);
		comp_cratio_bkgd->SetLineColor(kRed);
		comp_cratio_bkgd->Scale(0.75);
	...
	if( comp_cfbratio ){
		...
		comp_cfbratio->GetXaxis()->SetTitleSize(0.045);
		comp_cfbratio->GetXaxis()->SetTitleOffset(1.0);
	...
	if( comp_pfpc ){
		...
		comp_pfpc->GetXaxis()->SetTitle("#phi_{fcal} - #phi_{ccal} [#circ]");
		comp_pfpc->GetXaxis()->SetTitleSize(0.045);
		comp_pfpc->GetXaxis()->SetTitleOffset(1.0);
		comp_pfpc->GetYaxis()->SetTitleOffset(1.4);
	...
	if( comp_cfb2d ){
		...
		comp_cfb2d->GetXaxis()->SetTitleSize(0.045);
		comp_cfb2d->GetXaxis()->SetTitleOffset(1.6);
		comp_cfb2d->GetXaxis()->SetLabelSize(0.03);
		comp_cfb2d->GetYaxis()->SetTitle("(E_{ccal} + E_{fcal}) / E_{beam}");
		comp_cfb2d->GetYaxis()->SetTitleSize(0.045);
		comp_cfb2d->GetYaxis()->SetTitleOffset(1.8);
		comp_cfb2d->GetYaxis()->SetLabelSize(0.03);
