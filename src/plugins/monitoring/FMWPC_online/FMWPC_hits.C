...
// hnamepath: /FMWPC/fmwpc_hit_layer_1
// hnamepath: /FMWPC/fmwpc_hit_layer_2
// hnamepath: /FMWPC/fmwpc_hit_layer_3
// hnamepath: /FMWPC/fmwpc_hit_layer_4
// hnamepath: /FMWPC/fmwpc_hit_layer_5
// hnamepath: /FMWPC/fmwpc_hit_layer_6

{
	...
	if(fmwpc_hit_layer_1){
		fmwpc_hit_layer_1->SetStats(0);
		fmwpc_hit_layer_1->Draw();
	}
	...
	if(fmwpc_hit_layer_2){
		fmwpc_hit_layer_2->SetStats(0);
		fmwpc_hit_layer_2->Draw();
	}
	...
	if(fmwpc_hit_layer_3){
		fmwpc_hit_layer_3->SetStats(0);
		fmwpc_hit_layer_3->Draw();
	}
	...
	if(fmwpc_hit_layer_4){
		fmwpc_hit_layer_4->SetStats(0);
		fmwpc_hit_layer_4->Draw();
	}
	...
	if(fmwpc_hit_layer_5){
		fmwpc_hit_layer_5->SetStats(0);
		fmwpc_hit_layer_5->Draw();
	}
	...
	if(fmwpc_hit_layer_6){
		fmwpc_hit_layer_6->SetStats(0);
		fmwpc_hit_layer_6->Draw();
	}
