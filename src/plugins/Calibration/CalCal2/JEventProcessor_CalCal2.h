...
private:
  ...
  double ApplyConstraint(double scale1,double scale2,
  ...
  double TRACK_CL_CUT,EHIT_MIN,TIME_CUT;
  double ECAL_SHOWER_MIN,FCAL_SHOWER_MIN;
  double PI0_LO_CUT,PI0_HI_CUT,ECAL_SCALE_FACTOR,FCAL_SCALE_FACTOR;
  ...
  TH1F *h2ECALprob,*h2FCALprob,*hECALFCALprob;
  TH2F *hEcalCounts2D,*hFcalCounts2D,*hEcalGains2D,*hFcalGains2D;
