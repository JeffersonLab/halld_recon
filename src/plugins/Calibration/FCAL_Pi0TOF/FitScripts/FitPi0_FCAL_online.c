...
void FitPi0_FCAL_lh2(TString path = "") {
  int ITERATION = 0;
  ...
  TString h_path = "";
  if (path.Contains("method0"))
    h_path = "FCAL_Pi0HFA";
  else if (path.Contains("method1"))
    h_path = "FCAL_Pi0TOF";
  else if (path.Contains("method2"))
    h_path = "FCAL_Pi0log";

  if (path.Contains("method-0"))
    h_path = "FCAL_Pi0HFA";
  else if (path.Contains("method-1"))
    h_path = "FCAL_Pi0TOF";
  else if (path.Contains("method-2"))
    h_path = "FCAL_Pi0log";
  ...
  TH1I * hPi0Mass = (TH1I *) gDirectory->Get(h_path + "/Pi0Mass");
  TH2F * hPi0MassVsChNum = (TH2F *) gDirectory->Get(h_path + "/Pi0MassVsChNum");
  TH2F * hPi0MassVsChNumWeighted = (TH2F *) gDirectory->Get(h_path + "/Pi0MassVsChNumWeighted");
  TH2F * hPi0MassVsChNumWeightedSquared = (TH2F *) gDirectory->Get(h_path + "/Pi0MassVsChNumWeightedSquared_Fid");

  TH2F * hPi0MassVsChNum_frac = (TH2F *) gDirectory->Get(h_path + "/Pi0MassVsChNum");
  TH2F * hPi0MassVsChNumWeighted_frac = (TH2F *) gDirectory->Get(h_path + "/Pi0MassVsChNumWeighted");
  TH2F * hPi0MassVsChNumWeightedSquared_frac = (TH2F *) gDirectory->Get(h_path + "/Pi0MassVsChNumWeightedSquared_Fid");

  TH2I * hPi0MassVsE = (TH2I *) gDirectory->Get(h_path + "/Pi0MassVsE");
  ...
  */
  ...
  for (int row = 0; row < kBlocksTall; row ++) {
    ...
    for (int col = 0; col < kBlocksWide; col ++) {
      ...
      int ring = thisRadius / 5.0;
      if( (thisRadius < radius ) && (thisRadius > innerRadius) ) {
	
	sq_vs_ch[m_numActiveBlocks] = ring;
	square_tab[ring].push_back(m_numActiveBlocks);
  ...
  for (int i = 0; i < sq_nb; i ++) {
    if (i != 0) {
      TString histo = Form(h_path + "/Pi0Mass_ring_%d", i);
      if (i > 21)
	histo = Form(h_path + "/Pi0Mass2g_ring_%d", i);
      cout << histo << endl;
  ...
  double min_etaMass = etaMass-0.05*etaMass;
  double max_etaMass = etaMass+0.05*etaMass;
  double min_pi0Sigm = 6.8;
  double max_pi0Sigm = 9.99;
  double min_etaSigm = 15.0;
  double max_etaSigm = 39.99;

  TH2F * DrawM_rg_pi0 = new TH2F("DrawM_rg_pi0", ";#font[42]{Ring #};#font[42]{Mean [MeV/#it{c}^{2}]};", 100, 0.0, 24.99, 100, min_pi0Mass, max_pi0Mass);
  TH2F * DrawW_rg_pi0 = new TH2F("DrawW_rg_pi0", ";#font[42]{Ring #};#font[42]{Width [MeV/#it{c}^{2}]};", 100, 0.0, 24.99, 100, min_pi0Sigm, max_pi0Sigm);
  Nicer2D(DrawM_rg_pi0, 0.05, 42, 505, 1.2, 1.4, 1.2);
  Nicer2D(DrawW_rg_pi0, 0.05, 42, 505, 1.2, 1.4, 1.2);

  TH2F * DrawM_rg_eta = new TH2F("DrawM_rg_eta", ";#font[42]{Ring #};#font[42]{Mean [MeV/#it{c}^{2}]};", 100, 0.0, 24.99, 100, min_etaMass, max_etaMass);
  TH2F * DrawW_rg_eta = new TH2F("DrawW_rg_eta", ";#font[42]{Ring #};#font[42]{Width [MeV/#it{c}^{2}]};", 100, 0.0, 24.99, 100, min_etaSigm, max_etaSigm);
  ...
  TLine.DrawLine(0, pi0Mass-0.01*pi0Mass, 24.99, pi0Mass-0.01*pi0Mass);
  TLine.DrawLine(0, pi0Mass+0.01*pi0Mass, 24.99, pi0Mass+0.01*pi0Mass);
  C1->Print(cleg + ".pdf");
  ...
  TLine.DrawLine(0, etaMass-0.01*etaMass, 24.99, etaMass-0.01*etaMass);
  TLine.DrawLine(0, etaMass+0.01*etaMass, 24.99, etaMass+0.01*etaMass);
  C1->Print(cleg + ".pdf");
  ...
  */
  ...
  for (int i = 0; i < ITERATION; i ++) {
    ...
    if (i < ITERATION) {
      ...
      h_aaMass[i] = (TH1F *) f_aaMass[i]->Get(h_path + "/Pi0Mass");
  ...
  TH2F * DrawM_pi0 = new TH2F("DrawM_pi0", ";#font[42]{Iteration #};#font[42]{Mean [MeV/#it{c}^{2}]};", 100, 0.0, (double) (ITERATION + 1), 100, min_pi0Mass, max_pi0Mass);
  TH2F * DrawW_pi0 = new TH2F("DrawW_pi0", ";#font[42]{Iteration #};#font[42]{Width [MeV/#it{c}^{2}]};", 100, 0.0, (double) (ITERATION + 1), 100, min_pi0Sigm, max_pi0Sigm);
  Nicer2D(DrawM_pi0, 0.05, 42, 505, 1.2, 1.4, 1.2);
  Nicer2D(DrawW_pi0, 0.05, 42, 505, 1.2, 1.4, 1.2);

  TH2F * DrawM_eta = new TH2F("DrawM_eta", ";#font[42]{Iteration #};#font[42]{Mean [MeV/#it{c}^{2}]};", 100, 0.0, (double) (ITERATION + 1), 100, min_etaMass, max_etaMass);
  TH2F * DrawW_eta = new TH2F("DrawW_eta", ";#font[42]{Iteration #};#font[42]{Width [MeV/#it{c}^{2}]};", 100, 0.0, (double) (ITERATION + 1), 100, min_etaSigm, max_etaSigm);
  ...
  TLine.DrawLine(0, pi0Mass-0.01*pi0Mass, (double) (ITERATION + 1), pi0Mass-0.01*pi0Mass);
  TLine.DrawLine(0, pi0Mass+0.01*pi0Mass, (double) (ITERATION + 1), pi0Mass+0.01*pi0Mass);
  C1->Print(cleg + ".pdf");
  ...
  TLine.DrawLine(0, etaMass-0.01*etaMass, (double) (ITERATION + 1), etaMass-0.01*etaMass);
  TLine.DrawLine(0, etaMass+0.01*etaMass, (double) (ITERATION + 1), etaMass+0.01*etaMass);
  C1->Print(cleg + ".pdf");
