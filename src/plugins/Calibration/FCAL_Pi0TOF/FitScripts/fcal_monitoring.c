...
void fcal_monitoring() {
  ...
  TString hname[] = {"XY/xy_all", "XY/xy_3GeV"};
  TH2F * h2D[3];
  for (int i = 0; i < 3; i ++) {
    if (i < 2) h2D[i] = (TH2F *) gDirectory->Get(hname[i]);
    else h2D[i] = (TH2F *) gDirectory->Get(hname[1]);
    ...
    else if (i == 1) cleg = "FCAL-pattern-for-Emax-larger-than-3GeV";
    else if (i == 2) cleg = "FCAL-pattern-for-Emax-larger-than-3GeV-and-with-bad-gains";
    ...
    //else if (i == 11) t->DrawLatex(-125, 132.5, "Pattern for E^{cluster}_{max} #geq 3 GeV");
    else if (i == 1) t->DrawLatex(-125, 132.5, "Pattern for E^{cluster}_{max} #geq 3 GeV");
    else if (i == 2) t->DrawLatex(-125, 132.5, "Pattern for E^{cluster}_{max} #geq 3 GeV");
    //if (i == 11) {
    if (i == 2) {
