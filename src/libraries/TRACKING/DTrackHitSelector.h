...
class DTrackHitSelector:public jana::JObject{
 public:
  ...
  virtual const DGEMTRDSegment *GetGEMTRDSegment(const DTrackFitter::Extrapolation_t &extrapolation,const vector<const DGEMTRDSegment*>&gemtrdsegments_in) const=0;  
