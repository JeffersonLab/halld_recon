...
class DTrackHitSelector:public jana::JObject{
 public:
  ...
  virtual void GetCGEMHits(const vector<DTrackFitter::Extrapolation_t> &extrapolations, const vector<const DCGEMHit*> &cgemhits_in, vector<const DCGEMHit*> &cgemhits_out) const=0;
  virtual void GetCGEMHits(const DReferenceTrajectory *rt, const vector<const DCGEMHit*> &cgemhits_in, vector<const DCGEMHit*> &cgemhits_out) const=0;
  ...
  void GetCGEMHits(const vector<DTrackFitter::Extrapolation_t> &extrapolations, const vector<const DCGEMHit*> &cgemhits_in, DTrackFitter *fitter) const;
  ...
  void GetCGEMHits(const DReferenceTrajectory *rt, const vector<const DCGEMHit*> &cgemhits_in, DTrackFitter *fitter) const;	
