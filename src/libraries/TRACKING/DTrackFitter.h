...
#define MY_QuietNaN std::numeric_limits<double>::quiet_NaN()
...
class DTrackFitter: public JObject{
	...
	return extrapolations;
		...
		// Wrappers
		fit_status_t FitTrack(const DVector3 &pos, const DVector3 &mom, double q, double mass,double t0=MY_QuietNaN,DetectorSystem_t t0_det=SYS_NULL);
