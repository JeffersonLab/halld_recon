...
// init
//------------------
jerror_t DL1MCTrigger_factory_DATA::init(void)
{
  ...
  gPARMS->SetDefaultParameter("TRIG:OUTPUT_TREE", OUTPUT_TREE,
			      "Write out tree with trigger information, for debugging.");
  gPARMS->SetDefaultParameter("TRIG:USE_RAW_SAMPLES", USE_RAW_SAMPLES,
...
// brun
//------------------
jerror_t DL1MCTrigger_factory_DATA::brun(jana::JEventLoop *eventLoop, int32_t runnumber)
{
...
// evnt
//------------------
jerror_t DL1MCTrigger_factory_DATA::evnt(JEventLoop *loop, uint64_t eventnumber){
...
// erun
//------------------
jerror_t DL1MCTrigger_factory_DATA::erun(void)
{
	return NOERROR;
}
...
// fini
//------------------
jerror_t DL1MCTrigger_factory_DATA::fini(void)
{
    if(OUTPUT_TREE) {
...
int  DL1MCTrigger_factory_DATA::Read_RCDB(int32_t runnumber, bool print_messages)
{
...
void DL1MCTrigger_factory_DATA::GetSeeds(JEventLoop *loop, uint64_t eventnumber, UInt_t &seed1, UInt_t &seed2, UInt_t &seed3){
