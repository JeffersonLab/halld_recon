...
TMap* DEventWriterROOT::Create_UserInfoMaps(DTreeBranchRegister& locBranchRegister, JEventLoop* locEventLoop, const DReaction* locReaction) const
{
	...
	if(gPARMS) {
		gPARMS->SetDefaultParameter("ANALYSIS:BCAL_VERBOSE_ROOT_OUTPUT",BCAL_VERBOSE_OUTPUT);
		gPARMS->SetDefaultParameter("ANALYSIS:FCAL_VERBOSE_ROOT_OUTPUT",FCAL_VERBOSE_OUTPUT);
		gPARMS->SetDefaultParameter("ANALYSIS:CCAL_VERBOSE_OUTPUT",CCAL_VERBOSE_OUTPUT);
