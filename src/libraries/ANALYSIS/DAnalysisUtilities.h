...
class DAnalysisUtilities : public JObject
{
	public:
		...
		int Calc_Momentum_UnusedTracks(const std::shared_ptr<const JEvent>& locEvent, const DParticleCombo* locParticleCombo, double &locSumPMag_UnusedTracks, DVector3 &locSumP3_UnusedTracks) const;
