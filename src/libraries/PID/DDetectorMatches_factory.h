...
class DDetectorMatches_factory : public JFactoryT<DDetectorMatches>
{
	...
	private:
		...
		void MatchToFMWPC_CPP(const DTrackTimeBased* locTrackTimeBased, const vector<const DFMWPCHit*>& locFMWPCHits, DDetectorMatches* locDetectorMatches) const;
  ...
  bool ENABLE_FCAL_SINGLE_HITS, ENABLE_ECAL_SINGLE_HITS,MATCH_TO_DIRC;
};
