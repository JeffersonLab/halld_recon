...
// BeginRun
//------------------
void DRFTime_factory_TOF::BeginRun(const std::shared_ptr<const JEvent>& event)
{
...
// Process
//------------------
void DRFTime_factory_TOF::Process(const std::shared_ptr<const JEvent>& event)
{
...
// EndRun
//------------------
void DRFTime_factory_TOF::EndRun()
{
	return;
}
...
// Finish
//------------------
void DRFTime_factory_TOF::Finish()
{
	return;
}
